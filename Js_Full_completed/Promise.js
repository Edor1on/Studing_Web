...
// Promises - ES6 (2015) - синтаксичний цукор над колбеками, який дозволяє писати асинхронний код більш читабельним та зручним способом
// сама функці Promise приймає в якості аргументу функцію, яка має два параметри: resolve та reject.
// Вони є функціями, які викликаються для зміни стану промісу на fulfilled або rejected відповідно.
...
promise
    ...
    .then(data2 => data2)   // Якщо ми не повертаємо новий проміс, то наступний then отримає результат попереднього, а не проміс
    .then(data => {
        return new Promise((resolve, reject) => {
            if (5 > 10) {
                console.log(data);
